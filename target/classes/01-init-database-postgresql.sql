...
-- Create schema
CREATE SCHEMA IF NOT EXISTS SOCIAL_UD;

-- Create tables
CREATE TABLE SOCIAL_UD.LOCATION_TYPE
(
    LOCATION_TYPE_CODE        VARCHAR(3)  NOT NULL PRIMARY KEY,
    LOCATION_TYPE_DESCRIPTION VARCHAR(20) NOT NULL
);

CREATE TABLE SOCIAL_UD.LOCATION
(
    LOCATION_CODE      VARCHAR(4)  NOT NULL PRIMARY KEY,
    LOCATION_TYPE_CODE VARCHAR(3)  NOT NULL
        CONSTRAINT FK_LOCATION_TYPE REFERENCES SOCIAL_UD.LOCATION_TYPE,
    LOCATION_NAME      VARCHAR(30) NOT NULL,
    PARENT_LOCATION    VARCHAR(4)
...
(
    ...
    USER_UNIQUE_NAME  VARCHAR(6)  NOT NULL,
    USER_MODIFIER     VARCHAR(5)  NULL
...
(
    USER_A VARCHAR(5) NOT NULL,
    USER_B VARCHAR(5) NOT NULL,
...
(
    FOLLOWER_USER_ID VARCHAR(5) NOT NULL,
    FOLLOWED_USER_ID VARCHAR(5) NOT NULL,
...
(
    ...
    PARENT_PROPERTY_ID   VARCHAR(8)   NULL
        CONSTRAINT FK_PROPERTY_PARENT REFERENCES SOCIAL_UD.PROPERTY (PROPERTY_ID),
    PROPERTY_DESCRIPTION VARCHAR(100) NULL,
    PROPERTY_VALUE       VARCHAR(30)  NULL,
...
(
    CONTENT_TYPE_ID  VARCHAR(2)  NOT NULL PRIMARY KEY,
    TYPE_DESCRIPTION VARCHAR(30) NOT NULL
);

CREATE TABLE SOCIAL_UD.FILE_TYPE
(
    FILE_TYPE_ID          VARCHAR(3)  NOT NULL PRIMARY KEY,
    FILE_TYPE_DESCRIPTION VARCHAR(30) NOT NULL
);
